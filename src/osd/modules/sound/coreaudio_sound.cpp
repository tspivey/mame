...
public:
	...
	virtual void stream_update(uint32_t, int16_t const *buffer, int samples_this_frame) override;
...
void sound_coreaudio::stream_update(uint32_t, int16_t const *buffer, int samples_this_frame)
{
